...
// // Connect to MongoDB
// mongoose.connect('mongodb+srv://indrajitkopnar:8390259966@cluster0.g8pbnni.mongodb.net/Register?retryWrites=true&w=majority', {
...
// Connect to MongoDB
mongoose
  .connect('mongodb+srv://indrajitkopnar:8390259966@cluster0.g8pbnni.mongodb.net/Books_QBH?retryWrites=true&w=majority', {
    useNewUrlParser: true,
    useUnifiedTopology: true,
  })
  .then(() => {
...
const bookSchema = new mongoose.Schema({
  ...
  author: {
    ...
    ref: 'Author', // Ensure 'Author' matches the model name
    required: true,
  },
  publishedYear: {
    type: Number,
